...
function renderVistaAuditoriaAdmin() {
  ...
  body.innerHTML =
    '<div class="admin-toolbar">' +
      '<input type="text" id="admin-buscar-auditoria" data-tooltip="adminAuditoriaBuscar" placeholder="Filtrar por acción o usuario…">' +
      adminBoton('Mostrar más', 'mostrarMasAuditoriaAdmin()', '', null, 'adminAuditoriaMas') +
    '</div>' +
