...
export function validarBaseCxP() {
    ...
    // La habilitacion la manda el BACKEND por base (`cxp_habilitado` en
    // /api/bases): el frontend ya no tiene la constante de pais.
    const habilitada = window.BASES_DISPONIBLES_FRONT?.[base]?.cxp_habilitado === true;
