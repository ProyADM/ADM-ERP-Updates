# modules/shared/idempotencia.py
# ============================================================
...
# Lo comparten Stock (`modules/stock/routes.py`) y CxP
# (`modules/cxp/routes.py`): una sola implementacion del mecanismo.
#
...
# Ruta por defecto: <app>/data/idempotencia_stock.json. El NOMBRE del archivo no
# cambia al mover el modulo (es el mismo JSON que ya usa Stock en produccion:
# renombrarlo dejaria de reconocer las claves vigentes de un reintento en curso).
