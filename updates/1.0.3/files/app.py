...
def resolver_resultado_relanzamiento():
    ...
    Se llama UNA vez al arrancar. Si la app ya esta corriendo, el reinicio salio
    bien (aunque el relanzador no haya llegado a escribir nada): en ese caso, un
    estado que quedo en 'reiniciando' pasa a 'completado'.
    """
    try:
        estado_previo = {}
        ...
        if estado_previo.get('estado') != 'reiniciando':
            return
...
if __name__ == "__main__":
    ...
    # el estado final y no uno intermedio.
    resolver_resultado_relanzamiento()
