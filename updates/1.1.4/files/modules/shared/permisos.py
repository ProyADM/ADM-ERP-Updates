...
class PermisosSistema:
    ...
    DESCRIPCIONES = {
        ...
        "stock.eliminar": "Anular movimientos de stock (POST /api/stock/anular): exige motivo y queda auditado. El borrado de artículos todavía no existe y la pantalla de anulación queda pendiente.",
    ...
    # (auditoría del 14/09/2026: 29 de 63 permisos del catálogo; 28 desde el
    # 18/09/2026, cuando `stock.eliminar` se conectó al endpoint de anulación).
    #
