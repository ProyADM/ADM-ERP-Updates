  ...
  body.innerHTML =
    '<div class="admin-panel"><h4>Almacén</h4>' +
      ...
      '<div class="admin-toolbar" style="margin-top:12px">' +
        adminBoton('Traer cambios ahora', 'recargarAlmacenAdmin()', '', 'admin.acceso', 'adminEstadoRecargar') +
        adminBoton('Exportar respaldo', 'exportarConfigAdmin()', '', 'admin.backup', 'adminEstadoRespaldo') +
      '</div></div>' +
    ...
    '<div class="admin-panel"><h4>Importar respaldo</h4>' +
      ...
      '<div class="admin-campo"><label>Ruta del respaldo</label>' +
        '<input type="text" id="admin-importar-ruta" data-tooltip="adminEstadoImportar" placeholder="data\\config_export_....json"></div>' +
      '<div class="admin-toolbar">' +
        adminBoton('Importar', 'importarConfigAdmin()', 'admin-btn-peligro', 'admin.restaurar', 'adminEstadoImportarBtn') +
      '</div></div>';
