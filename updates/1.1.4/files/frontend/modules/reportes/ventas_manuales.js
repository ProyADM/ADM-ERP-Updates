                    ...
                    <tr>
                        ...
                        <td>
                            ${v.puede_borrar
                              ...
                              : '<span style="color:#94a3b8;font-size:11px;" title="Solo podés borrar ventas de tus países habilitados">—</span>'}
                        </td>
                    </tr>
                `;
            });
...
export function eliminarVentaManual(id) {
    if (!confirm('¿Estás seguro de eliminar esta venta manual? Se borra para todos los usuarios.')) return;
